<template>
  <div class="dashboard-container">
    ...
    <main class="dashboard-content">
      ...
      <h2>Welcome, Sales Rep 💼</h2>
      <p>You can <strong>add</strong> and <strong>edit</strong> customers from here.</p>
...
<style scoped>
/* Copy the same styles as Support/Admin */
.dashboard-container {
  height: 100vh;
  display: flex;
...
.customers-btn:hover { background: #059669; }
...
.tile-title { font-size: 1rem; font-weight: 600; opacity: 0.85; }
.tile-value { font-size: 2rem; font-weight: 700; }
.tile-icon svg { height: 2rem; width: 2rem; }
</style>
